...
/** Generated Model for Z_MB_InOut
 *  @author Adempiere (generated) 
 *  @version Release 3.9.0 - $Id$ */
public class X_Z_MB_InOut extends PO implements I_Z_MB_InOut, I_Persistent 
{
...
// N
    ...
    /** Load Constructor */
    public X_Z_MB_InOut (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_Z_MB_InOut[")
	...
	{
		if (Z_MB_InOut_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_Z_MB_InOut_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_Z_MB_InOut_ID, Integer.valueOf(Z_MB_InOut_ID));
	}
